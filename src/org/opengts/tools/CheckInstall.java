...
public class CheckInstall
{
    ...
    public static final String FILE_SIG_DIRS[]      = { "ant","bin","private","src","war","webService" };
    ...
    public static void main(String argv[])
    {
        ...
        // -- ELog/HOS
        {
            ...
            ELogHOSProvider elog = Device.getELogHOSProvider();
            if (elog != null) {
                ...
                for (BasicPrivateLabel privLabel : privLabelSet) {
                    ...
                    */
                    ...
                    if (privLabel.isCustomSmtpProperties()) {
                      ...
                      //SendMail.SmtpProperties spDft = new SendMail.SmtpProperties();
                        SendMail.SmtpProperties spBPL = privLabel.getSmtpProperties();
