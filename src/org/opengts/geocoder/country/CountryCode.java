...
public class CountryCode
{
    ...
    **/
    ...
    public static final CountryInfo CountryMapArray[] = new CountryInfo[] {
        ...
        new CountryInfo("CA", "CAN",      "1", "Canada"                 , Canada.class, "getProvinceName"),
        ...
        new CountryInfo("MX", "MEX",     "52", "Mexico"                 , Mexico.class, "getStateName"),
        ...
        new CountryInfo("US", "USA",      "1", "United States"          , USState.class, "getStateName"),
