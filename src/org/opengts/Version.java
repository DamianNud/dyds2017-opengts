...
//  2015/05/03 v2.5.9,  2015/09/24 v2.6.0,  2016/01/17 v2.6.1,
//  2016/06/10 v2.6.2
// ----------------------------------------------------------------------------
package org.opengts;
...
public class Version
{
    ...
    public  static final String COPYRIGHT = "Copyright 2007-2016, GeoTelematic Solutions, Inc.";

    // ------------------------------------------------------------------------

    // -- This string is parsed via 'grep' & 'sed' scripts.
    // -- ONLY the version value specified within the quotes should change.
    private static final String VERSION = "2.6.2"; // -B74, 2.6.1-B53, 2.6.0-B87
    ...
    private static final long PACKAGE_TIMESTAMP = 1465585082L;
