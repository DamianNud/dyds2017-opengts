    ...
    */
        ...
        throws IOException
    {
        ...
        if (allowNewDevMode == DEVMODE_MAXLIMIT) {
            ...
            if (!sysadminLogin && 
                currAcct.exceedsMaximumDevices(currAcct.getDeviceCount()+1,false/*0=unlim?*/)) {
        ...
        if (currAcct.exceedsMaximumDevices(currAcct.getDeviceCount()+1,true/*0=unlim*/)) {
            // -- deny if over limit
            Print.logInfo("Allow New Device? Deny - over limit");
            allowNew    = false;
          //allowDelete = false; <== leave as-is (allow delete, for now)
        ...
        if (!allowSmsCmd && Print.isDebugLoggingLevel()) {
            ...
            if ((SMSCommandHandler != null) && !SMSCommandHandler.hasSmsCommands(reqState)) {
                    ...
                    if (showFuelProf && _viewFuelPrf) {
                        ...
                        switch (fuelProfType) {
                            ...
                            case 1: { // "text"
                                ...
                                // -- #1
                                out.println(FormRow_SubSeparator());
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE1, _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile1","Fuel Tank #1 Profile")+":", profSel1, 80, 250, null));
                                // -- #2
                                out.println(FormRow_SubSeparator());
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE2, _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile2","Fuel Tank #2 Profile")+":", profSel2, 80, 250, null));
                                } break;
                            case 2: { // "select"
                                // -- view as ComboBox
                            ...
                            case 3: { // "scale"
                                ...
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE1_SCALE, _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile1Scale" ,"Fuel Tank #1 Profile Scale" )+":", scale1 , 5, 5, null));
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE1_OFFS , _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile1Offset","Fuel Tank #1 Profile Offset")+":", offset1, 5, 5, null));
                                }
                                // -- #2
                                {
                                ...
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE2_SCALE, _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile2Scale" ,"Fuel Tank #2 Profile Scale" )+":", scale2 , 5, 5, null));
                                out.println(FormRow_TextField(PARM_DEV_FUEL_PROFILE2_OFFS , _editFuelPrf, i18n.getString("DeviceInfo.fuelProfile2Offset","Fuel Tank #2 Profile Offset")+":", offset2, 5, 5, null));
                                }
                                } break;
                        }
                    }
