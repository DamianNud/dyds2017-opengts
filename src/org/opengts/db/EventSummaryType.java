...
public class EventSummaryType
{
  ...
  //public static final int     TYPE_PRECALC_SUMMARY_MONTHLY    = 0x40000;
    ...
    public static final String  STYPE_EVENT_INVALID_GPS_NAME    = TYPE_EVENT_COUNT_NAME_ + "InalidGPS";
    ...
    **/
    public static EventSummaryType CreateStatusCodeSummeryType(int sc)
    {
    ...
    **/
    public static EventSummaryType CreateSimilarCodeSummeryType(int sc)
    {
    ...
    **/
    public static EventSummaryType GetEventSummaryType(int type, int subtype)
    {
        if (type == TYPE_STATUSCODE_COUNT) {
            int sc = subtype;
            if ((sc > 0) && (sc <= 0xFFFF)) {
                return EventSummaryType.CreateStatusCodeSummeryType(sc);
            } else {
                return null;
            }
        } else
        if (type == TYPE_SIMILARCODE_COUNT) {
            int sc = subtype;
            if ((sc > 0) && (sc <= 0xFFFF)) {
                return EventSummaryType.CreateSimilarCodeSummeryType(sc);
            } else {
                return null;
            }
        } else {
