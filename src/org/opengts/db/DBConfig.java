...
public class DBConfig
{
    ...
    **/
    ...
    /**
    *** Runtime Configuration Property<br>
    *** Failed Account login interval and maximum attempts<br>
    *** Requires SystemAudit table.<br>
    *** Type: long
    **/
    public static final String PROP_Account_failedLoginInterval         = "Account.failedLoginInterval";
    public static final String PROP_Account_failedLoginAttempts         = "Account.failedLoginAttempts";

    /**
    *** Runtime Configuration Property<br>
    *** Failed User login interval and maximum attempts<br>
    *** Requires SystemAudit table.<br>
    *** Type: long
    **/
    public static final String PROP_User_failedLoginInterval            = "User.failedLoginInterval";
    public static final String PROP_User_failedLoginAttempts            = "User.failedLoginAttempts";
    ...
    **/
    private static <T extends DBRecord<T>> void _displayDependencyTree(int level, DBFactory<T> fact)
    {
        if (fact != null) {
    ...
    **/
    public static int _main(String argv[])
    {
        ...
        if (RTConfig.hasProperty(ARG_INIT_TABLES)) {
            ...
            //   db.sql.dbname=<DataBase_Name>    - GRANT only
        }
