  ...
  //public static final String FLD_newUserRoleID            = "newUserRoleID";
    ...
    **/
    public void updatePasswordFields()
        throws DBException
    {
        this.update(Account.FLD_password, Account.FLD_tempPassword);
    }
    ...
    **/
    ...
    /**
    *** Returns true if ELog Username is present
    **/
