  ...
  //public static final int  MAY                = MAY;
    ...
    **/
    public static void main(String argv[])
    {
        ...
        /* EXP/XOR time */
        if (RTConfig.hasProperty(ARG_EXP)) {
            long     tsec = timeSec;
            long     xor  = StringTools.parseHexLong(RTConfig.getString(ARG_EXP,null),0L);
            long     txor = (tsec ^ xor) & 0xFFFFFFFFL;
            DateTime dt   = new DateTime(tsec,tz);
            Print.sysPrintln("Time: "+dt+" [exp "+StringTools.toHexString(txor,32)+"]");
            System.exit(0);
        }
