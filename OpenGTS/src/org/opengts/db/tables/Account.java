  ...
  //public static final String FLD_eLogMaxTokenIndex        = "eLogMaxTokenIndex";     // ELog/HOS maximum SSO token index
    ...
    **/
        ...
        throws DBException
    {
        ...
        if (acctMgr != null) {
            ...
            acct.setSmsProperties(acctMgr.getSmsProperties());/*mdf*/// comment/remove this line
        }
    ...
    **/
        ...
        throws DBException
    {
        ...
        /* Set of all current defined AccountIDs */
        if (acctIdSet == null) {
        ...
        dsel.setSelectedFields(AccountRecord.FLD_accountID);
        dsel.setGroupByFields(AccountRecord.FLD_accountID);
