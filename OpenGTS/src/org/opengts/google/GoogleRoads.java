...
public class GoogleRoads
{
  ...
  //public    static final double   SNAPTOROAD_MaxDistanceM = 300.0; // recommended, but not practical
    ...
    /* properties */
    public    static final String   PROP_roadsApiKey        = "roadsApiKey";
    public    static final String   PROP_speedLimitsURL     = "speedLimitsURL";
    public    static final String   PROP_snapToRoadsURL     = "snapToRoadsURL";
    public    static final String   PROP_maxSnapDistanceM   = "maxSnapDistanceM";
