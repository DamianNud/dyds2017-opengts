...
public class GoogleDirections
{
    ...
    **/
    ...
    /**
    *** Returns the Directions API timeout
    **/
    ...
    **/
    public static java.util.List<GeoPointProvider> DecodePolyline(String polyline, java.util.List<GeoPointProvider> gpList)
    {
        ...
        for (int n = 0; n < rtSize; n++) {
            ...
            if (routesObj != null) {
                                ...
                                if (stepsObj != null) {
                                    ...
                                    if (polylineObj != null) {
                                        ...
                                        if (!StringTools.isBlank(points)) {
                                            ...
                                            DecodePolyline(points,stepPolyList);
                ...
                if (overviewPolylineObj != null) {
                    ...
                    if (!StringTools.isBlank(points)) {
                        DecodePolyline(points,summaryPolyList);
                        /*
                        int x1 = 0, x2 = 0;
                        for (;;) {
