...
public class SmtpProperties
{
    ...
    **/
    ...
    { // [2.6.2-B52]
        ...
        return StringTools.trim(this._getString(KEY_MULTIPART_TYPE,true));
    }
    ...
    **/
    ...
    private static final String SSL_OPTIONS[] = { "yes", "true", "only" }; // omit "false"
    ...
    **/
    public void setEnableSSL(String V)
    {
        ...
        if (!StringTools.isBlank(V) && ListTools.contains(SSL_OPTIONS,V.trim().toLowerCase())) {
            this.smtpProps.setString(KEY_ENABLE_SSL[0], V.trim().toLowerCase());
        }
    }
    ...
    **/
    ...
    private static final String TLS_OPTIONS[] = { "yes", "true", "only" }; // omit "false"
    ...
    **/
    public void setEnableTLS(String V)
    {
        ...
        if (!StringTools.isBlank(V) && ListTools.contains(TLS_OPTIONS,V.trim().toLowerCase())) {
            this.smtpProps.setString(KEY_ENABLE_TLS[0], V.trim().toLowerCase());
        }
    }
